...
ifeq ($(OS),Windows_NT)
    ...
    OBJ_DIR=obj
    INC_DIR=inc
    CFLAGS=/I $(SRC_DIR) /I $(INC_DIR) /W3 /WX /Zi /Od /MD /MP
    LDFLAGS=/link /LIBPATH:'./lib/' SDL2.dll SDL2.lib SDL2main.lib math
else
    CC=gcc
    SRC_DIR=src
    OBJ_DIR=obj
    INC_DIR=inc
    CFLAGS=-I$(SRC_DIR) -I$(INC_DIR) -Wall -Wextra -Wpedantic -g -O1 -MMD -MP
    LDFLAGS=-L/usr/local/lib -lSDL2 -lSDL2main -lm
endif
